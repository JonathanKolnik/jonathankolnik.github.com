...
function Validate(){
	var errorString = ""
	var errorTrue = ""
//if(document.Subscribe.SubscriptionTypeID.checked == true)
	var i
for(i=0;i<document.Subscribe.SubscriptionTypeID.length;i++)
{
	if(document.Subscribe.SubscriptionTypeID[i].checked==true)
		document.Subscribe.hidSubscriptionChargeSelected.value=document.Subscribe.hidSubscriptionCharge[i].value 
	//else
	//	'alert('0')
//alert(document.Subscribe.SubscriptionTypeID.length)
}
//alert(document.Subscribe.hidSubscriptionChargeSelected.value)
//hidSubscriptionCharge = 


document.Subscribe.hidBillingStateProvinceID.value = document.Subscribe.BillingStateProvinceID.options[document.Subscribe.BillingStateProvinceID.selectedIndex].text
document.Subscribe.hidBillingCountryID.value = document.Subscribe.BillingCountryID.options[document.Subscribe.BillingCountryID.selectedIndex].text
document.Subscribe.hidShippingStateProvinceID.value = document.Subscribe.ShippingStateProvinceID.options[document.Subscribe.ShippingStateProvinceID.selectedIndex].text
document.Subscribe.hidShippingCountryID.value = document.Subscribe.ShippingCountryID.options[document.Subscribe.ShippingCountryID.selectedIndex].text
document.Subscribe.hidCreditCardTypeID.value = document.Subscribe.CreditCardTypeID.options[document.Subscribe.CreditCardTypeID.selectedIndex].text
//alert(document.Subscribe.CreditCardTypeID.options[document.Subscribe.CreditCardTypeID.selectedIndex].text)
                                ...
                                <table width="350" border="0" cellspacing="0" cellpadding="2">
                                  <tr align="left"> 
                                    <td colspan="2" class="CastlesTextBody"><b>Subscription 
                                      Type* </b>
                                      <input type="hidden" name="hidSubscriptionChargeSelected" id="hidSubscriptionChargeSelected"> 
...
%>
                                  <tr align="left"> 
                                    <td class="CastlesTextBody" align="right" width="150" valign="top"> 
                                      ...
                                      <input type="hidden" name="hidSubscriptionCharge[]" value="<%=SubscriptionTypes.Fields.Item("Price").Value%>" id="hidSubscriptionCharge"> 
                                    </td>
...
%>
                                      ...
                                      <input type="hidden" name="hidBillingStateProvinceID" id="hidBillingStateProvinceID">
                                    </td>
                                  </tr>
                                  <tr> 
...
%>
                                       ...
                                       <input type="hidden" name="hidBillingCountryID" id="hidBillingCountryID">
                                    </td>
                                  </tr>
                                  <tr> 
...
%>
                                       ...
                                       <input type="hidden" name="hidShippingStateProvinceID" id="hidShippingStateProvinceID">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td width="150" align="right" class="CastlesTextBody">Zip/Postal 
...
%>
                                       ...
                                       <input type="hidden" name="hidShippingCountryID" id="hidShippingCountryID">
                                    </td>
                                  </tr>
                                  <tr> 
...
%>
                                       ...
                                       <input type="hidden" name="hidCreditCardTypeID" id="hidCreditCardTypeID">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td width="150" class="CastlesTextBody" align="right">Credit 
