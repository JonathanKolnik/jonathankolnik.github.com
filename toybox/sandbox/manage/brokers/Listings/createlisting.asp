...
PageTopNavigationSubHeaderID = 36
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input name="Active" type="hidden" id="Active" value="N">
                              </td>
                            </tr>
                          </table>
                        </td>
                        <td width="365" class="CastlesTextBody" valign="top"> 
                          <table cellspacing="0" cellpadding="3" border="0" width="365">
                            <tr> 
                              <td  class="CastlesTextBody">[&nbsp;28&nbsp;] Hot 
                                Water:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;29&nbsp;] Heating:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;30&nbsp;] Cooling:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;31&nbsp;] Exterior 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;33&nbsp;] Interior 
                                Features:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;34&nbsp;] Appliances:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;35&nbsp;] Flooring:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;36&nbsp;] Foundation 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;38&nbsp;] Exterior 
                                Description:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>							
							...
							<tr> 
                              <td class="CastlesTextBody">&nbsp;&nbsp;<font color="#FF0000">* Note: 
                                ...
                                images to a web format (eg. JPEG or GIF).</font></td>
                            </tr>
                            <tr valign="top">
<%
