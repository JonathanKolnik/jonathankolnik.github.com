...
PageTopNavigationSubHeaderID = 38
                      ...
                      <tr> 
                        ...
                        <td rowspan="14" valign="top"> 
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            <tr>
                              <td class="CastlesTextBody">[&nbsp;1&nbsp;] ListingID:</td>
                            </tr>
                            <tr>
                              <td class="CastlesTextBlack"><input name="txtListingID" type="text" disabled class="CastlesTextBlack" id="txtListingID" value="<%=ListingID%>" size="30" maxlength="100">
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;2&nbsp;] Address:</td>
                            </tr>
                            <tr> 
...
%>							
							<tr> 
                              <td class="CastlesTextBody"><input type="checkbox" name="ShowAddress" value="Y" <%=checked%> disabled>&nbsp;Show Address on Website?</td>
                            </tr>							
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;3&nbsp;] Unit:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;4&nbsp;] City:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
...
%>
							...
							<tr> 
                              <td width="200" class="CastlesTextBody">[&nbsp;7&nbsp;] 
                                Country: </td>
                            </tr>
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Area:</td>
                            </tr>
                            <tr> 
...
%>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;9&nbsp;] Area 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;10&nbsp;] Property 
                                Style:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;11&nbsp;] Property Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;12&nbsp;] Total 
                                Rooms:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;13&nbsp;] Bedrooms:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;14&nbsp;] Full Baths:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;15&nbsp;] Half 
                                Baths:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;16&nbsp;] Lot 
                                Size:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;17&nbsp;] Year 
                                Built:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;18&nbsp;] Living 
                                Area:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;19&nbsp;] List 
                                Price:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;20&nbsp;] Assessment:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;21&nbsp;] Tax 
                                Year:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;22&nbsp;] Annual 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;23&nbsp;] Listing Status:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
...
%>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;24&nbsp;] Waterfront:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;25&nbsp;] Ski:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;26&nbsp;] Condo:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;27&nbsp;] Resort:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;28&nbsp;] Country Club:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;29&nbsp;] Farm/Ranch:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;30&nbsp;] <%=WordPhrase_Active%>:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
...
if Pic = "" OR isNull(Pic) then
	Pic = "http://www.castlesmag.com/manage/images/noPic.gif"
end if
%>
