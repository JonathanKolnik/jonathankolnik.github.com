...
PageTopNavigationSubHeaderID = 3
EntityID = 1
%>
<!--#include virtual="/templates/castlessystemcnekt.asp" -->
<%
'---------------Begin Page Level Multilingual Translation-----------------------
WordPhrasesOnPage = "Active(|)Administrator Info(|)Create Administrator(|)Create Notes(|)Delete Notes(|)Direct Line(|)Email Address(|)Fax Number(|)First Name(|)Language(|)Last Name(|)Middle Initial(|)Mobile Phone(|)Nick Name(|)No(|)Password(|)Show Help(|)System Access Rights(|)System Notes Access(|)Username(|)View Notes(|)Yes"
...
TranslateCount = TranslateCount + 1
WordPhrase_CreateAdministrator = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <form name="CreateEntity" method="post" onSubmit="return Validate();" action="driveadministrators.asp?DCDataDriverType=SQLInsert&SearchColumn=<%=SearchColumn%>&SearchValue=<%=SearchValue%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                      ...
                      <tr> 
                        ...
                        <td rowspan="14" class="CastlesTextDark" valign="top"> 
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="DirectLine" class="CastlesTextBlack" size="20" maxlength="40">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="MobileTelNumber" class="CastlesTextBlack" size="20" maxlength="40">
                              </td>
                            </tr>
                            <tr> 
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                ...
                                <input type="submit" name="Submit" value="<%=WordPhrase_CreateAdministrator%>" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
