...
PageTopNavigationSubHeaderID = 5
...
WordPhrasesOnPage = "Active(|)Administrator Info(|)Create Notes(|)Delete Notes(|)Direct Line(|)Edit Administrator(|)Email Address(|)Fax Number(|)First Name(|)Language(|)Last Name(|)Middle Initial(|)Mobile Phone(|)Nick Name(|)No(|)Password(|)Show Help(|)System Access Rights(|)System Notes Access(|)Username(|)View Notes(|)Yes"
...
WordPhrase_AdministratorInfo = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
...
TranslateCount = TranslateCount + 1
WordPhrase_EditAdministrator = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
...
AdministratorID = Request.QueryString("AdministratorID")
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
	.CommandText = "Castles_System_Administrator_Profile_System"
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4)
	.Parameters.Append .CreateParameter("@AdministratorID", 200, 1,200,AdministratorID)
	.CommandType = 4
	.CommandTimeout = 0
	.Prepared = true
	Set AdministratorProfile = .Execute()
End With
Set Command1 = Nothing

'Administrator SystemLogin Info
EntitySystemLoginID = AdministratorProfile.Fields.Item("SystemLoginID").Value
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
	...
	.CommandTimeout = 0
	.Prepared = true
	Set AdministratorSystemLoginInfo = .Execute()
End With
Set Command1 = Nothing
EntityLanguageID = AdministratorSystemLoginInfo.Fields.Item("LanguageID").Value
%>
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td bgcolor="<%=TitleBar%>" width="100%" class="CastlesTextHeader" height="20">&nbsp;&nbsp;&nbsp;<b><%=UCase(WordPhrase_AdministratorInfo)%></b></td>
              </tr>
                <tr> 
                        ...
                        <table width="350" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="FirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=AdministratorProfile.Fields.Item("FirstName").Value%>" disabled>
                              &nbsp;&nbsp; 
                              <input type="text" name="MiddleInitial" class="CastlesTextBlack" size="3" maxlength="1" value="<%=AdministratorProfile.Fields.Item("MiddleInitial").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="LastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=AdministratorProfile.Fields.Item("LastName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;3&nbsp;] <%=WordPhrase_DirectLine%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="DirectLine" class="CastlesTextBlack" size="20" maxlength="40" value="<%=AdministratorProfile.Fields.Item("DirectLine").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;4&nbsp;] <%=WordPhrase_MobilePhone%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="MobileTelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=AdministratorProfile.Fields.Item("MobileTelNumber").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;5&nbsp;] <%=WordPhrase_FaxNumber%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="FaxNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=AdministratorProfile.Fields.Item("FaxNumber").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;6&nbsp;] <%=WordPhrase_EmailAddress%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=AdministratorProfile.Fields.Item("EmailAddress").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;7&nbsp;] <%=WordPhrase_Language%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <%
...
Next
%>
                              <select name="EntityLanguageID" class="CastlesTextBlack" disabled>
                                <%=LanguageList%> 
                              </select>
                            </td>
                          </tr>
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <select name="Active" class="CastlesTextBlack" disabled>
                                <%If AdministratorProfile.Fields.Item("Active").Value = "Y" Then%>
                          ...
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;9&nbsp;] <%=WordPhrase_NickName%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="NickName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=AdministratorSystemLoginInfo.Fields.Item("NickName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;10&nbsp;] <%=WordPhrase_UserName%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="UserName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=AdministratorSystemLoginInfo.Fields.Item("UserName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody"> [&nbsp;11&nbsp;] <%=WordPhrase_Password%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="password" name="Password" class="CastlesTextBlack" size="17" maxlength="10"  value="<%=AdministratorSystemLoginInfo.Fields.Item("Password").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;12&nbsp;] <%=WordPhrase_ShowHelp%>:</td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <select name="ShowHelpContent" class="CastlesTextBlack" disabled>
                                <%If AdministratorSystemLoginInfo.Fields.Item("ShowHelpContent").Value = "Y" Then%>
                                <option value="Y" selected><%=WordPhrase_Yes%></option>
                                <option value="N"><%=WordPhrase_No%></option>
                                <%Else%>
                                <option value="Y"><%=WordPhrase_Yes%></option>
                          ...
                          <tr> 
                            <td class="CastlesTextBody">[&nbsp;13&nbsp;] <%=WordPhrase_SystemNotesAccess%>:</td>
                          </tr>
                          <tr> 
                            <td> 
                              <table width="200" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="20"> 
                                    <%
If AdministratorSystemLoginInfo.Fields.Item("CreateNotes").Value = "Y" Then
%>
                                    <input type="checkbox" name="CreateNotes" value="Y" checked disabled>
                                    <%
Else
%>
                                    <input type="checkbox" name="CreateNotes" value="Y" disabled>
                                    <%
End If
%>
                                  </td>
                                ...
                                <tr> 
                                  <td width="20"> 
                                    <%
If AdministratorSystemLoginInfo.Fields.Item("DeleteNotes").Value = "Y" Then
%>
                                    <input type="checkbox" name="DeleteNotes" value="Y" checked disabled>
                                    <%
Else
%>
                                    <input type="checkbox" name="DeleteNotes" value="Y" disabled>
                                    <%
End If
%>
                                  </td>
                      ...
                      <td width="365" class="CastlesTextBody">[&nbsp;14&nbsp;] 
...
SystemLoginTypeID = AdministratorSystemLoginInfo.Fields.Item("SystemLoginTypeID").Value
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
...
%>
                            <tr> 
                              <td width="15" class="CastlesTextHeader" bgcolor="<%=LightField%>"> 
                                <%
		If inStr(HeaderAccessRightsString,ParenTopNavigationHeaderID) = 0 Then
%>
                                <input type="checkbox" name="TopNavigationHeaderID<%=HeaderCount%>" value="<%=SystemLoginAccessRightsList.Fields.Item("TopNavigationHeaderID").Value%>" disabled>
                                <%
		Else
%>
                                <input type="checkbox" name="TopNavigationHeaderID<%=HeaderCount%>" value="<%=SystemLoginAccessRightsList.Fields.Item("TopNavigationHeaderID").Value%>" checked disabled>
                                <%
		End If
%>
                              </td>
                              <td width="265" colspan="2" class="CastlesTextBody" bgcolor="<%=LightField%>"><b><%=SystemLoginAccessRightsList.Fields.Item("TopNavigationHeaderName").Value%></b></td>
                            </tr>
                            <tr> 
                              <td width="15" bgcolor="<%=LightField%>">&nbsp;</td>
                              <td width="15" class="CastlesTextBody" bgcolor="<%=LightField%>"> 
                                <input type="hidden" name="TopNavigationHeaderIDForSubHeader<%=SubHeaderCount%>" value="<%=SystemLoginAccessRightsList.Fields.Item("TopNavigationHeaderID").Value%>" disabled>
                                <%
		If inStr(SubHeaderAccessRightsString,ParenTopNavigationSubHeaderID) = 0 Then
%>
                                <input type="checkbox" name="TopNavigationSubHeaderID<%=SubHeaderCount%>" value="<%=SystemLoginAccessRightsList.Fields.Item("TopNavigationSubHeaderID").Value%>" disabled>
                                <%
		Else
%>
                                <input type="checkbox" name="TopNavigationSubHeaderID<%=SubHeaderCount%>" value="<%=SystemLoginAccessRightsList.Fields.Item("TopNavigationSubHeaderID").Value%>" checked disabled>
                                <%
		End If
%>
                              </td>
