...
PageTopNavigationSubHeaderID = 30
...
'response.write "SearchListingID: " & SearchListingID & "<br>"
'response.write "SearchedStates: " & SearchedStates & "<br>"
'response.write "SearchedSizes: " & SearchedSizes & "<br>"
'response.write "SearchedAddress: " & SearchedAddress & "<br>"
'response.write "SearchedApartmentStatus: " & SearchedApartmentStatus & "<br>"
'response.write "PriceFrom: " & PriceFrom & "<br>"
'response.write "PriceTo: " & PriceTo & "<br>"
'response.write "Page: " & Page & "<br>"
'response.write "TotalRecords: " & TotalRecords & "<br>"
...
function Validate(){
	...
	if (document.EditEntity.Assessment.value  != false) {
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <form name="EditEntity" method="post" enctype="multipart/form-data" onSubmit="return Validate();" action="drivelistings.asp?DCDataDriverType=SQLUpdate&SearchListingID=<%=SearchListingID%>&SearchedAddress=<%=SearchedAddress%>&SearchedStates=<%=SearchedStates%>&SearchedSizes=<%=SearchedSizes%>&SearchedApartmentStatus=<%=SearchedApartmentStatus%>&PriceFrom=<%=PriceFrom%>&PriceTo=<%=PriceTo%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                          ...
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="Address" class="CastlesTextBlack" size="30" maxlength="100" value="<%=ListingProfile.Fields.Item("Address").Value%>">
                                &nbsp;&nbsp; </td>
                            </tr>
<%
...
%>							
							<tr> 
                              <td class="CastlesTextBody"><input type="checkbox" name="ShowAddress" value="Y" <%=checked%>>&nbsp;Show Address on Website?</td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="Unit" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("Unit").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="City" class="CastlesTextBlack" size="30" maxlength="100" value="<%=ListingProfile.Fields.Item("City").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="ZipCode" class="CastlesTextBlack" size="20" maxlength="15" value="<%=ListingProfile.Fields.Item("ZipCode").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
...
%>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;9&nbsp;] Property 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="TotalRooms" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("TotalRooms").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="Bedrooms" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("Bedrooms").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;12&nbsp;] Full 
                                Baths:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="FullBaths" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("FullBaths").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="HalfBaths" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("HalfBaths").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
								<input type="text" name="LotSize" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("LotSize").Value%>">
                                sq. ft. <span class="CastlesTextBlack"> <font color="#FF0000">*</font></span></td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
								<input type="text" name="YearBuilt" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("YearBuilt").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span> </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
								<input type="text" name="LivingArea" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("LivingArea").Value%>">
                                sq. ft.</td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ListPrice" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("ListPrice").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
<% if ListingProfile.Fields.Item("ShowListPrice").Value = "Y" then %>
                              <td class="CastlesTextBody"><input type="checkbox" name="ShowListPrice" value="Y" checked>&nbsp;Show List Price on Website?</td>
<% else %>
...
<% end if %>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="Assessment" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("Assessment").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
								<input type="text" name="TaxYear" class="CastlesTextBlack" size="10" maxlength="20" value="<%=Trim(ListingProfile.Fields.Item("TaxYear").Value)%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
								<input type="text" name="Taxes" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("Taxes").Value%>">  <span class="CastlesTextBody"><font color="#FF0000">*</font></span>
                              </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;21&nbsp;] Listing 
                                Status:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="StatusID" class="CastlesTextBlack">
<%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
%>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;22&nbsp;] Waterfront:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;24&nbsp;] Condo:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;25&nbsp;] Resort:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;26&nbsp;] Country 
                                Club:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;27&nbsp;] Farm/Ranch:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;27&nbsp;] Castle:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="Castle" class="CastlesTextBlack">
                                  <%If ListingProfile.Fields.Item("Castle").Value = "Y" Then%>
                                  <option value="Y" selected><%=WordPhrase_Yes%></option>
                                  <option value="N"><%=WordPhrase_No%></option>
                                  <%Else%>
                                  <option value="Y"><%=WordPhrase_Yes%></option>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;28&nbsp;] <%=WordPhrase_Active%>:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;29&nbsp;] Featured:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="FeaturedProperty" class="CastlesTextBlack">
                                  <%If ListingProfile.Fields.Item("FeaturedProperty").Value = "Y" Then%>
                                  <option value="Y" selected><%=WordPhrase_Yes%></option>
                                  <option value="N"><%=WordPhrase_No%></option>
                                  <%Else%>
                                  <option value="Y"><%=WordPhrase_Yes%></option>
							...
							<tr>
                              <td class="CastlesTextBody">[&nbsp;29B&nbsp;] Current Listing:</td>
						    </tr>
							<tr>
                              <td class="CastlesTextBlack">
                                <select name="CurrentListing" class="CastlesTextBlack">
                                  <%If ListingProfile.Fields.Item("CurrentListing").Value = "Y" Then%>
                                  <option value="Y" selected><%=WordPhrase_Yes%></option>
                                  <option value="N"><%=WordPhrase_No%></option>
                                  <%Else%>
                                  <option value="Y"><%=WordPhrase_Yes%></option>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="FeaturedTitle" class="CastlesTextBlack" size="30" maxlength="100" value="<%=ListingProfile.Fields.Item("FeaturedTitle").Value%>">
                                &nbsp;&nbsp; </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;31&nbsp;] Featured 
                                Description:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <textarea name="FeaturedDescription" cols="30" rows="5" class="CastlesTextBlack" wrap="VIRTUAL"><%=ListingProfile.Fields.Item("FeaturedDescription").Value%></textarea>
                              </td>
                            </tr>
                          </table>
                        </td>
                        <td width="365" class="CastlesTextBody" valign="top"> 
                          <table cellspacing="0" cellpadding="3" border="0" width="365">
                            <tr> 
                              <td  class="CastlesTextBody">[&nbsp;32&nbsp;] Hot 
                                Water:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;33&nbsp;] Heating:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;34&nbsp;] Cooling:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;36&nbsp;] Exterior 
                                Features:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;37&nbsp;] Interior 
                                Features:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;38&nbsp;] Appliances:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;39&nbsp;] Flooring:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;40&nbsp;] Foundation 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;41&nbsp;] Interior 
                                Description:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <textarea name="InteriorDescription" cols="30" rows="5" class="CastlesTextBlack" wrap="VIRTUAL"><%=ListingProfile.Fields.Item("InteriorDescription").Value%></textarea>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;42&nbsp;] Exterior 
                                Description:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <textarea name="ExteriorDescription" cols="30" rows="5" class="CastlesTextBlack" wrap="VIRTUAL"><%=ListingProfile.Fields.Item("ExteriorDescription").Value%></textarea>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;43&nbsp;] Broker:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
While (NOT Brokers.EOF)
	If ListingProfile.Fields.Item("BrokerID").Value = Brokers.Fields.Item("BrokerID").Value Then
%>
                                  <option value="<%=(Brokers.Fields.Item("BrokerID").Value)%>" selected><%=(Brokers.Fields.Item("CompanyName").Value)%> 
...
<%
	fieldNumber = fieldNumber + 1
Next
ListingPublishStatusID = ListingProfile.Fields.Item("ListingPublishStatusID").Value
if ListingPublishStatusID = 0 or isNull(ListingPublishStatusID) then
%>							
                         	<tr> 
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                ...
                                <input type="submit" name="Submit" value="Edit Listing" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
