...
PageTopNavigationSubHeaderID = 6
EntityID = 2
%>
...
WordPhrasesOnPage = "Actions(|)Edit(|)No Results Found(|)WebSite Content Name"
...
TranslateCount = TranslateCount + 1
WordPhrase_WebSiteContentName = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
...
With Command1	
	.ActiveConnection = Connect
	.CommandText = "Castles_System_WebSiteContent_List"
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4)
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td> 
            <table width="750" border="0" cellspacing="0" cellpadding="3">
              <tr> 
                <td align="right" colspan="3" height="1"><img src="../../../../Castles/manage/administration/images/clear10pixel.gif" width="1" height="1"></td>
              </tr>
                <tr> 
                  <td colspan="3" height="1"><img src="../../../../Castles/manage/administration/images/clear10pixel.gif" width="1" height="1"></td>
                </tr>
            </table>
          </td>
        </tr>
          <tr> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="20">
              <tr> 
                  <td bgcolor="#000000" colspan="20" height="1"><img src="../../../../Castles/manage/administration/images/clear10pixel.gif" width="1" height="1"></td>
                </tr>
                <tr height="20"> 
                  <td bgcolor="<%=TitleBar%>" width="1%">&nbsp;</td>
                  
                <td bgcolor="<%=TitleBar%>" width="20%" class="CastlesTextHeader"><b><%=WordPhrase_WebSiteContentName%></b></td>
                  <td bgcolor="<%=TitleBar%>" width="1%">&nbsp;</td>
                  
                <td bgcolor="<%=TitleBar%>" width="20%" class="CastlesTextHeader" align="left"><b><%=WordPhrase_Actions%></b></td>
                  <td bgcolor="<%=TitleBar%>" width="1%">&nbsp;</td>
                  <td bgcolor="<%=TitleBar%>" width="10%" class="CastlesTextHeader"><b></b></td>
                  <td bgcolor="<%=TitleBar%>" width="1%">&nbsp;</td>
...
If Not SearchResults.EOF Then
	...
	Field_WebSiteContentID = 0
	Field_WebSiteContentName = 1

	For SearchResultsArrayRowCounter = 0 to SearchResultsArrayNumRows
		WebSiteContentID = SearchResultsArray(Field_WebSiteContentID,SearchResultsArrayRowCounter)
		WebSiteContentName = SearchResultsArray(Field_WebSiteContentName,SearchResultsArrayRowCounter)
...
%>
                <tr> 
                  <td colspan="15" height="1"><img src="../../../../Castles/manage/administration/images/clear10pixel.gif" width="1" height="1"></td>
                </tr>
                <tr bgcolor="<%=ThinLine%>"> 
                  <td colspan="15" height="1"><img src="../../../../Castles/manage/administration/images/clear10pixel.gif" width="1" height="1"></td>
                </tr>
                ...
                <td width="20%" class="CastlesTextBody"><%=WebSiteContentName%></td>
                  <td width="1%" align="center">&nbsp;</td>
                  
                <td width="20%" class="CastlesTextBody" align="left"><a href="editwebsitecontent.asp?WebSiteContentID=<%=WebSiteContentID%>&WebSiteContentLanguageID=<%=LanguageID%>&WebSiteContentName=<%=Server.URLEncode(WebSiteContentName)%>" class="normal"><b><%=WordPhrase_Edit%></b></a>&nbsp;</td>
                  <td width="1%" align="center">&nbsp;</td>
