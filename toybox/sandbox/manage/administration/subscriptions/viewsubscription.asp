...
PageTopNavigationSubHeaderID = 42
...
With Command1	
	.ActiveConnection = Connect
	.CommandText = "Castles_System_Subscriptions_Profile_System"
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4)
	.Parameters.Append .CreateParameter("@SubscriptionID", 200, 1,200,SubscriptionID)
	.CommandType = 4
	.CommandTimeout = 0
	.Prepared = true
	Set SubscriptionProfile = .Execute()
End With
Set Command1 = Nothing
%>
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td bgcolor="<%=TitleBar%>" width="100%" class="CastlesTextHeader" height="20">&nbsp;&nbsp;&nbsp;<b>Subscription Info</b></td>
              </tr>
              <form name="EditEntity" method="post" onSubmit="return Validate();" action="drivesubscription.asp?DCDataDriverType=SQLUpdate&SearchColumn=<%=SearchColumn%>&SearchValue=<%=SearchValue%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                          ...
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="BillingFirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("BillingFirstName").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="BillingLastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("BillingLastName").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="BillingAddressLine1" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("BillingAddressLine1").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="BillingAddressLine2" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("BillingAddressLine2").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="BillingCity" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("BillingCity").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <select name="BillingStateProvinceID" class="CastlesTextBlack" disabled>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
While (NOT StateProvinces.EOF)
	If SubscriptionProfile.Fields.Item("BillingStateProvinceID").Value = StateProvinces.Fields.Item("StateProvinceID").Value Then
%>
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="BillingZipPostalCode" class="CastlesTextBlack" size="15" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("BillingZipPostalCode").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <select name="BillingCountryID" class="CastlesTextBlack" disabled>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
While (NOT Countries.EOF)
	If SubscriptionProfile.Fields.Item("BillingCountryID").Value = Countries.Fields.Item("CountryID").Value Then
%>
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="TelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=SubscriptionProfile.Fields.Item("TelNumber").Value%>" disabled>
                              </td>
                            </tr>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("EmailAddress").Value%>" disabled>
                              </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Subscription Comments:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <textarea name="SubscriberComments" class="CastlesTextBlack" cols="30" rows="4" disabled><%=(SubscriptionProfile.Fields.Item("SubscriberComments").Value)%></textarea>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="Active" class="CastlesTextBlack" disabled>
                                  <%If SubscriptionProfile.Fields.Item("Active").Value = "Y" Then%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="SubscriptionTypeID" class="CastlesTextBlack" disabled>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
While (NOT SubscriptionTypes.EOF)
	if SubscriptionProfile.Fields.Item("SubscriptionTypeID").Value = SubscriptionTypes.Fields.Item("SubscriptionTypeID").Value then
		makeSelected = "selected"
	else
		makeSelected = ""
	end if
%>
                                  <option value="<%=(SubscriptionTypes.Fields.Item("SubscriptionTypeID").Value)%>" <%=makeSelected%>><%=(SubscriptionTypes.Fields.Item("SubscriptionTypeName").Value)%> - <%=FormatCurrency(SubscriptionTypes.Fields.Item("Price").Value,2)%></option>
<%
...
%>
                        ...
                        <td width="365" valign="top"> 
                          <table width="365" border="0" cellspacing="0" cellpadding="3">
						  	<tr> 
                              <td class="CastlesTextBody">
								<input type="checkbox" name="UseBilling" class="CastlesTextBlack" value="Y" onClick="SameAsBilling();" disabled>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ShippingFirstName" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingFirstName").Value%>" disabled>
                              </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;3&nbsp;] Shipping 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ShippingLastName" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingLastName").Value%>" disabled>
                              </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;3&nbsp;] Shipping 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ShippingAddressLine1" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingAddressLine1").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                              <td width="200" class="CastlesTextBody">[&nbsp;4&nbsp;] 
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="ShippingAddressLine2" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingAddressLine2").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="ShippingCity" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingCity").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <select name="ShippingStateProvinceID" class="CastlesTextBlack" disabled>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
While (NOT StateProvinces.EOF)
	If SubscriptionProfile.Fields.Item("ShippingStateProvinceID").Value = StateProvinces.Fields.Item("StateProvinceID").Value Then
%>
                                  <option value="<%=(StateProvinces.Fields.Item("StateProvinceID").Value)%>" selected><%=(StateProvinces.Fields.Item("StateProvinceName").Value)%></option>
                                  <%
	Else
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="ShippingZipPostalCode" class="CastlesTextBlack" size="15" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("ShippingZipPostalCode").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <select name="ShippingCountryID" class="CastlesTextBlack" disabled>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
While (NOT Countries.EOF)
	If SubscriptionProfile.Fields.Item("ShippingCountryID").Value = Countries.Fields.Item("CountryID").Value Then
%>
                                  <option value="<%=(Countries.Fields.Item("CountryID").Value)%>" selected><%=(Countries.Fields.Item("CountryName").Value)%></option>
                                  <%
	Else
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardHolderName" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("CreditCardHolderName").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <select name="CreditCardTypeID" class="CastlesTextBlack" disabled>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
	.ActiveConnection = connect
...
While (NOT CreditCardTypes.EOF)
	If SubscriptionProfile.Fields.Item("CreditCardTypeID").Value = CreditCardTypes.Fields.Item("CreditCardTypeID").Value Then
%>
                                  <option value="<%=(CreditCardTypes.Fields.Item("CreditCardTypeID").Value)%>" selected><%=(CreditCardTypes.Fields.Item("CreditCardTypeName").Value)%></option>
                                  <%
	Else
%>
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <%
DisplayCCNum = SubscriptionProfile.Fields.Item("CreditCardNumber").Value
if DisplayCCNum <> "" then
	DisplayCCNum = DecryptCreditCardNumber(DisplayCCNum)

	DisplayCCNumLen = Len(DisplayCCNum)
	lastFourDigits =  right(DisplayCCNum,4)
	xString = ""

	for i = 1 to  (DisplayCCNumLen-4) 
		xString = xString & "X"                                         
	next

	DisplayCCNumXX = xString & lastFourDigits
end if
%>
                                <input type="text" name="CreditCardNumber" class="CastlesTextBlack" size="25" maxlength="50" value="<%=DisplayCCNumXX%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardCSCCode" class="CastlesTextBlack" size="25" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("CreditCardCSCCode").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardExpirationMonth" class="CastlesTextBlack" size="5" maxlength="2" value="<%=SubscriptionProfile.Fields.Item("CreditCardExpirationMonth").Value%>" disabled>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardExpirationYear" class="CastlesTextBlack" size="10" maxlength="4" value="<%=SubscriptionProfile.Fields.Item("CreditCardExpirationYear").Value%>" disabled>
                              </td>
                            </tr>
                          </table>
                          <br>
