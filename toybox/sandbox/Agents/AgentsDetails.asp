...
With Command1	
	...
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4) 
	.Parameters.Append .CreateParameter("@BrokerID", 200, 1,200,contentID)
	.CommandType = 4
	.CommandTimeout = 0
	.Prepared = True
	Set BrokerDetails = .Execute()
End With
Set Command1 = Nothing


if not BrokerDetails.eof then
	CompanyName=BrokerDetails.Fields.Item("CompanyName").Value
	FirstName=BrokerDetails.Fields.Item("FirstName").Value
	LastName=BrokerDetails.Fields.Item("LastName").Value
	MiddleInitial=BrokerDetails.Fields.Item("MiddleInitial").Value
	AddressLine1=BrokerDetails.Fields.Item("AddressLine1").Value
	AddressLine2=BrokerDetails.Fields.Item("AddressLine2").Value
	City=BrokerDetails.Fields.Item("City").Value
	StateProvinceID=BrokerDetails.Fields.Item("StateProvinceID").Value
	ZipPostalCode=BrokerDetails.Fields.Item("ZipPostalCode").Value
	CountryID=BrokerDetails.Fields.Item("CountryID").Value
	TelNumber=BrokerDetails.Fields.Item("TelNumber").Value
	FaxNumber=BrokerDetails.Fields.Item("FaxNumber").Value
	EmailAddress=BrokerDetails.Fields.Item("EmailAddress").Value
	PersonalWebPage=BrokerDetails.Fields.Item("PersonalWebPage").Value
	BioPicture=BrokerDetails.Fields.Item("BioPicture").Value
end if
                    ...
                    <tr> 
                      ...
                      <td width="375" valign="top"> 
                        <table width="375" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr> 
                            <td class="CastlesTextBody" colspan=2><%=WebSiteContentBody1%> </td>
                          </tr>
                          <tr> 
                            <td class="CastlesTextBody" colspan=2>&nbsp;</td>
                          </tr>
                          ...
                          <tr> 
							<td class="CastlesTextBody" valign="top" width=250>
							<span class="CastlesTextBody"><b><%=FirstName & " " & LastName%></b></span><br>
							<%=CompanyName%><br>
	                        <%=AddressLine1%><br>
							<%=AddressLine2%><br>
							<%=city%><br>
							...
							%>
							<b>phone:</b>&nbsp;<%=TelNumber%><br>
							<b>fax:</b>&nbsp;<%=FaxNumber%><br>
							<b>email:</b>&nbsp;<a href="mailto:<%=EmailAddress%>" class="black"><%=EmailAddress%></a><br>
<%
If Len(PersonalWebPage) <> 0 Then
%>
							<strong>personal web page:</strong>&nbsp;<a href="<%=PersonalWebPage%>" class="black" target="_blank"><%=PersonalWebPage%></a>

<%
End If
%>
</td>
						<td class="CastlesTextBody" valign="top" width=125 height=158><%if len(trim(BioPicture)) > 0 then%><img src="../images/<%=BioPicture%>" width="125" height="150"><%end if%>&nbsp;
						</td>
						</tr>
                          <tr><td colspan=2>&nbsp;</td></tr>
							<tr><td align="right" class="CastlesTextBody" colspan=2><a href="default.asp" class="black">Back To Agents Page</a>&nbsp;</td></tr>
                        </table>
                      </td>
                      <td width="10"><img src="../images/clear10pixel.gif" width="10" height="1"></td>
                    </tr>
