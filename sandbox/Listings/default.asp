...
With Command1	
	...
	if Request.QueryString("cID") <> "" and Request.QueryString("cID") <> 0 then
		.CommandText = "Castles_ClientSide_StateProvinceAndCountry_DynamicList_New"
		.Parameters.Append .CreateParameter("@CountryID", 3, 1, 4, trim(Request.QueryString("cID")))
		'Response.Write(0)	
	else
		'Response.Write(1)
		.CommandText = "Castles_ClientSide_StateProvinceAndCountry_DynamicList"		
	end if
	'Response.end()
...
With Command1	
	.ActiveConnection = Connect
	.CommandText = "Castles_ClientSide_Country_DynamicList"
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4)
	.CommandType = 4
	.CommandTimeout = 0
	.Prepared = True
	Set Countrylist = .Execute()
End With
Set Command1 = Nothing
...
function doSearch(){
	//alert("Zipcode is: " + document.ListingsSearch.Zipcode.value);
	var errorExists = "";
	var NoZipcode;
	//if(document.ListingsSearch.SearchZipcode.value==""){
	//	NoZipcode = true;
	//}else{
		//NoZipcode = false;
	//}
	//if((document.ListingsSearch.SearchStateProvinceID.value=="0")&&(NoZipcode)){
		//var NoAreaSpecified = true;
		//errorExists = "y";
	//}
	var PriceFrom = parseInt(document.ListingsSearch.SearchPriceFrom.value);
	var PriceTo = parseInt(document.ListingsSearch.SearchPriceTo.value);
	//alert("PriceFrom is: " + PriceFrom);
	//alert("PriceTo is: " + PriceTo);
	if(PriceFrom >= PriceTo){
		var IncorrectPriceRange = true;
		errorExists = "y";
	}
	var errorString = "";
	//if(NoAreaSpecified){
	//	errorString = errorString + " - Please select an area by choosing a state/country or by entering a zipcode.\r";
	//}
	if(IncorrectPriceRange){
		errorString = errorString + " - The 'Price From' cannot equal or exceed the 'Price To', please correct the price range.\r";
	}
	if(errorExists=="y"){
		alert(errorString);
	}else{
		document.ListingsSearch.submit();
	}
}
function GetState(thevalue){
	var CountryID = thevalue.value
	document.ListingsSearch.action="default.asp?cID=" + CountryID;
	document.ListingsSearch.submit();
}
//-->
</script>
        ...
        <tr> 
          ...
          <td width="595" valign="top" colspan="4"><!-- #BeginEditable "body" --> 
            <table width="595" border="0" cellspacing="0" cellpadding="0">
              <form name="ListingsSearch" method="post" action="searchResults.asp">
                <tr> 
                  <td width="10" bgcolor="#D6D4BA">&nbsp;</td>
                  <td width="176" bgcolor="#D6D4BA"> 
                    <table width="130" border="0" cellspacing="0" cellpadding="3" height="20">
                      <tr> 
                        <td class="CastlesTextBodyBold">Search Listings</td>
                      </tr>
                    </table>
                  </td>
                  <td width="200" bgcolor="#D6D4BA">&nbsp;</td>
                </tr>
                <tr> 
                  <td colspan="3" height="2"><img src="../images/clear10pixel.gif" width="1" height="2"></td>
                </tr>
                <tr bgcolor="#EDEBDB"> 
                  ...
                  <td width="320" class="CastlesTextBody" bgcolor="#EDEBDB">&nbsp;</td>
                  <td width="250" bgcolor="#EDEBDB" valign="top" rowspan="12"> 
                    <table width="250" cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td> 
                          <input type="checkbox" name="SearchWaterfront" value="Y">
                        </td>
                        <td width="225" class="CastlesTextBody">&nbsp;&nbsp;Waterfront</td>
                      </tr>
                      <tr> 
                        <td> 
                          <input type="checkbox" name="SearchSki" value="Y">
                        </td>
                        <td width="225" class="CastlesTextBody">&nbsp;&nbsp;Ski</td>
                      </tr>
                      <tr> 
                        <td> 
                          <input type="checkbox" name="SearchCondo" value="Y">
                        </td>
                        <td width="225" class="CastlesTextBody">&nbsp;&nbsp;Condo</td>
                      </tr>
                      <tr> 
                        <td> 
                          <input type="checkbox" name="SearchResort" value="Y">
                        </td>
                        <td width="225" class="CastlesTextBody">&nbsp;&nbsp;Resort</td>
                      </tr>
                      <tr> 
                        <td> 
                          <input type="checkbox" name="SearchCountryClub" value="Y">
                        </td>
                        <td width="225" class="CastlesTextBody">&nbsp;&nbsp;Country 
                          Club</td>
                      </tr>
                      <tr> 
                        <td> 
                          <input type="checkbox" name="SearchFarmOrRanch" value="Y">
                        </td>
                        <td width="225" class="CastlesTextBody">&nbsp;&nbsp;Farm/Ranch</td>
                      </tr>
                    </table>
                  </td>
                </tr>
               <tr bgcolor="#EDEBDB"> 
                  <td width="10" bgcolor="#EDEBDB">&nbsp;</td>
                  <td width="320" class="CastlesTextBody"> Country:&nbsp;&nbsp;&nbsp; 
                    <select name="CountryID" class="CastlesTextBlack" onchange="GetState(this);">
                      <option value="0" selected>All</option>
                      <%
While NOT Countrylist.EOF
	If Request.QueryString("cID") <> "" Then %>
                <option value="<%=Countrylist.Fields.Item("CountryID").Value%>" <%if trim(Countrylist.Fields.Item("CountryID").Value) = trim(Request.QueryString("cID")) then%>Selected<%end if%>><%=Countrylist.Fields.Item("CountryName").Value%></option>
        <%
	else	%>
		<option value="<%=Countrylist.Fields.Item("CountryID").Value%>" <%if trim(Countrylist.Fields.Item("CountryID").Value) = 1 then%>Selected<%end if%>><%=Countrylist.Fields.Item("CountryName").Value%></option>
<%
end if
...
%>
				...
				<tr bgcolor="#EDEBDB"> 
                  <td width="10" bgcolor="#EDEBDB">&nbsp;</td>
                  <td width="320" class="CastlesTextBodyBold">&nbsp;</td>
                </tr>
			    <tr bgcolor="#EDEBDB"> 
                  <td width="10" bgcolor="#EDEBDB">&nbsp;</td>
                  <td width="320" class="CastlesTextBody"> State:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select name="SearchStateProvinceID" class="CastlesTextBlack">
                      <option value="0" selected>All</option>
                      <%
While NOT StateAndCountry.EOF
%>
                      <option value="<%=StateAndCountry.Fields.Item("StateProvinceID").Value%>"><%=StateAndCountry.Fields.Item("StateProvinceName").Value%></option>
                      <%
	StateAndCountry.MoveNext()
Wend
StateAndCountry.close
%>
                    </select>
                  </td>
                </tr>
                ...
                <tr bgcolor="#EDEBDB"> 
                  <td width="10" bgcolor="#EDEBDB">&nbsp;</td>
                  <td width="320" class="CastlesTextBody"> 
                    <table width="320" cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td class="CastlesTextBody">City:</td>
                        <td class="CastlesTextBody">&nbsp;</td>
                        <td class="CastlesTextBody">Zip Code:</td>
                      </tr>
                      <tr> 
                        <td> 
                          <input type="text" name="SearchCity" size="20" maxlength="50" class="CastlesTextBlack">
                        </td>
                        <td class="CastlesTextBody"><b>- OR -</b></td>
                        <td> 
                          <input type="text" name="SearchZipcode" size="20" maxlength="50" class="CastlesTextBlack" onblur="Isnumeric(this)" >
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr bgcolor="#EDEBDB"> 
                  ...
                  <td width="320" class="CastlesTextBody"> 
                    <table width="320" cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td class="CastlesTextBody">Price From:</td>
                        <td class="CastlesTextBody">Price To:</td>
                      </tr>
                      <tr> 
                        <td> 
                          <select name="SearchPriceFrom" class="CastlesTextBlack">
                        ...
                        <td> 
                          <select name="SearchPriceTo" class="CastlesTextBlack">
                            <option value="100000000000" selected>Maximum</option>
                            <option value="1000000">$1,000,000</option>
                ...
                <tr bgcolor="#EDEBDB"> 
                  <td colspan="2" height="10"><img src="../images/clear10pixel.gif" width="1" height="10"></td>
                </tr>
                <tr> 
                  <td colspan="2" height="10" bgcolor="#EDEBDB"><img src="../images/clear10pixel.gif" width="1" height="10"></td>
                </tr>
				<tr> 
                  <td colspan="2" height="10" bgcolor="#EDEBDB"><img src="../images/clear10pixel.gif" width="1" height="10"></td>
                </tr>
                <tr bgcolor="#EDEBDB"> 
                  <td width="10" bgcolor="#EDEBDB">&nbsp;</td>
                  <td width="320" class="CastlesTextBody" align="right"><input type="button" name="search" value="Search" class="CastlesTextBlack" onClick="doSearch()"></td>
                </tr>
              </form>
            </table>
            <!-- #EndEditable --></td>
  ...
  <tr>
  	<td width="750">
		<table width="750" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="595"><!-- #BeginEditable "subBody" -->
<table width="595" border="0" cellspacing="0" cellpadding="0">
              <tr> 
              ...
              <tr> 
                <td width="595" valign="top"> 
                  <table width="595" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="100"><a href="ListingDetails.asp?ListingID=<%=id1%>"><img src="<%=pic1%>" width="100" height="100" border="0" onError=this.src="/manage/images/noPic.gif"></a></td>
                      <td width="495"> 
                        <table width="495" border="0" cellspacing="0" cellpadding="0" height="75">
                          ...
                          <tr bgcolor="#EDEBDB"> 
                            ...
                            <td width="280" class="CastlesTextBody" bgcolor="#FFFFFF"><span class="CastlesTextBodyBold"><%=title1%><% if Not IsNull(ShowListPrice1) then %> <% if ShowListPrice1 = "Y" then %> - <%=FormatCurrency(price1,0)%><% else %><B>Price Upon Request</B><% end if %><% end if %></span><br>
                              <%=desc1%> <span class="CastlesTextBodyBold">[&gt;<a href="ListingDetails.asp?ListingID=<%=id1%>" class="normal">More</a>]</span></td>
                    ...
                    <tr> 
                      <td width="100"><a href="ListingDetails.asp?ListingID=<%=id2%>"><img src="<%=pic2%>" width="100" height="100" border="0" onError=this.src="/manage/images/noPic.gif"></a></td>
                      <td width="495"> 
                        <table width="495" border="0" cellspacing="0" cellpadding="0" height="75">
                          <tr bgcolor="#EDEBDB"> 
                            <td width="2" height="10" bgcolor="#FFFFFF"><img src="../images/clear10pixel.gif" width="2" height="10"></td>
                          ...
                          <tr bgcolor="#EDEBDB"> 
                            ...
                            <td width="280" class="CastlesTextBody" bgcolor="#FFFFFF"><span class="CastlesTextBodyBold"><%=title2%><% if Not IsNull(ShowListPrice2) then %> <% if ShowListPrice2 = "Y" then %> - <%=FormatCurrency(price2,0)%><% else %><B>Price Upon Request</B><% end if %><% end if %></span><br>
                              <%=desc2%><span class="CastlesTextBodyBold">[&gt;<a href="ListingDetails.asp?ListingID=<%=id2%>" class="normal">More</a>]</span></td>
                            <td width="195" bgcolor="#FFFFFF">&nbsp;</td>
                          </tr>
                          <tr bgcolor="#EDEBDB"> 
                            <td width="2" height="10" bgcolor="#FFFFFF"><img src="../images/clear10pixel.gif" width="2" height="10"></td>
                    ...
                    <tr> 
                      <td width="100"><a href="ListingDetails.asp?ListingID=<%=id3%>"><img src="<%=pic3%>" width="100" height="100" border="0" onError=this.src="/manage/images/noPic.gif"></a></td>
                      <td width="495"> 
                        <table width="495" border="0" cellspacing="0" cellpadding="0" height="75">
                          <tr bgcolor="#EDEBDB"> 
                            <td width="2" height="10" bgcolor="#FFFFFF"><img src="../images/clear10pixel.gif" width="2" height="10"></td>
                          ...
                          <tr bgcolor="#EDEBDB"> 
                            ...
                            <td width="280" class="CastlesTextBody" bgcolor="#FFFFFF"><span class="CastlesTextBodyBold"><%=title3%><% if Not IsNull(ShowListPrice3) then %> <% if ShowListPrice3 = "Y" then %> - <%=FormatCurrency(price3,0)%><% else %><B>Price Upon Request</B><% end if %><% end if %></span><br>
                              <%=desc3%><span class="CastlesTextBodyBold">[&gt;<a href="ListingDetails.asp?ListingID=<%=id3%>" class="normal">More</a>]</span></td>
                            <td width="195" bgcolor="#FFFFFF">&nbsp;</td>
                          </tr>
                          <tr bgcolor="#EDEBDB"> 
                            <td width="2" height="10" bgcolor="#FFFFFF"><img src="../images/clear10pixel.gif" width="2" height="10"></td>
