...
PageTopNavigationSubHeaderID = 25
FromPageTopNavigationSubHeaderID = 24
EntityID = 7
%>
...
'Broker Profile Info
BrokerID = Request.QueryString("BrokerID")
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
...
'Broker SystemLogin Info
EntitySystemLoginID = BrokerProfile.Fields.Item("SystemLoginID").Value
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
	...
	.CommandTimeout = 0
	.Prepared = true
	Set BrokerSystemLoginInfo = .Execute()
End With
Set Command1 = Nothing
EntityLanguageID = BrokerSystemLoginInfo.Fields.Item("LanguageID").Value
%>
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td bgcolor="<%=TitleBar%>" width="100%" class="CastlesTextHeader" height="20">&nbsp;&nbsp;&nbsp;<b>BROKER INFO</b></td>
              </tr>
              <form name="EditEntity" method="post" enctype="multipart/form-data" onSubmit="return Validate();" action="driveBrokers.asp?DCDataDriverType=SQLUpdate&SearchColumn=<%=SearchColumn%>&SearchValue=<%=SearchValue%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                          ...
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="FirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=BrokerProfile.Fields.Item("FirstName").Value%>">
                                &nbsp;&nbsp; 
                                <input type="text" name="MiddleInitial" class="CastlesTextBlack" size="3" maxlength="1" value="<%=BrokerProfile.Fields.Item("MiddleInitial").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="LastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=BrokerProfile.Fields.Item("LastName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="CompanyName" class="CastlesTextBlack" size="30" maxlength="200" value="<%=BrokerProfile.Fields.Item("CompanyName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="AddressLine1" class="CastlesTextBlack" size="25" maxlength="100" value="<%=BrokerProfile.Fields.Item("AddressLine1").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="AddressLine2" class="CastlesTextBlack" size="25" maxlength="50" value="<%=BrokerProfile.Fields.Item("AddressLine2").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="City" class="CastlesTextBlack" size="25" maxlength="100" value="<%=BrokerProfile.Fields.Item("City").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
While (NOT StateProvinces.EOF)
	If BrokerProfile.Fields.Item("StateProvinceID").Value = StateProvinces.Fields.Item("StateProvinceID").Value Then
%>
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="ZipPostalCode" class="CastlesTextBlack" size="15" maxlength="50" value="<%=BrokerProfile.Fields.Item("ZipPostalCode").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
While (NOT Countries.EOF)
	If BrokerProfile.Fields.Item("CountryID").Value = Countries.Fields.Item("CountryID").Value Then
%>
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="TelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=BrokerProfile.Fields.Item("TelNumber").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="FaxNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=BrokerProfile.Fields.Item("FaxNumber").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=BrokerProfile.Fields.Item("EmailAddress").Value%>">
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td class="CastlesTextBlack">
                                <input type="text" name="PersonalWebPage" class="CastlesTextBlack" size="40" maxlength="300" value="<%=BrokerProfile.Fields.Item("PersonalWebPage").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="Active" class="CastlesTextBlack">
                                  <%If BrokerProfile.Fields.Item("Active").Value = "Y" Then%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="NickName" class="CastlesTextBlack" size="20" maxlength="10" value="<%=BrokerSystemLoginInfo.Fields.Item("NickName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="UserName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=BrokerSystemLoginInfo.Fields.Item("UserName").Value%>">
                              </td>
                            </tr>
<%
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="password" name="Password" class="CastlesTextBlack" size="17" maxlength="10"  value="<%=BrokerSystemLoginInfo.Fields.Item("Password").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <select name="ShowHelpContent" class="CastlesTextBlack">
                                  <%If BrokerSystemLoginInfo.Fields.Item("ShowHelpContent").Value = "Y" Then%>
                                  <option value="Y" selected><%=WordPhrase_Yes%></option>
                                  <option value="N"><%=WordPhrase_No%></option>
                                  <%Else%>
                                  <option value="Y"><%=WordPhrase_Yes%></option>
							...
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;13&nbsp;] Picture:</td>
                            </tr>
							<%if len(trim(BrokerProfile.Fields.Item("BioPicture").Value)) > 0 then%>
							<tr> 
                              <td class="CastlesTextBody">&nbsp;&nbsp;<img src="../../../images/<%=BrokerProfile.Fields.Item("BioPicture").Value%>" border=0 width="125" height="150"></td>
                            </tr>
							<%end if%>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                              ...
                              <td> 
                                <table width="200" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="20"> 
                                      <%
If BrokerSystemLoginInfo.Fields.Item("CreateNotes").Value = "Y" Then
%>
...
%>
                                  ...
                                  <tr> 
                                    <td width="20"> 
                                      <%
If BrokerSystemLoginInfo.Fields.Item("DeleteNotes").Value = "Y" Then
%>
...
SystemLoginTypeID = BrokerSystemLoginInfo.Fields.Item("SystemLoginTypeID").Value
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                ...
                                <input type="submit" name="Submit" value="Edit Broker" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
