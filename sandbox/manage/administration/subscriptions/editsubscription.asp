                          ...
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="BillingFirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("BillingFirstName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="BillingLastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("BillingLastName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="BillingAddressLine1" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("BillingAddressLine1").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="BillingAddressLine2" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("BillingAddressLine2").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="BillingCity" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("BillingCity").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="BillingZipPostalCode" class="CastlesTextBlack" size="15" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("BillingZipPostalCode").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="TelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=SubscriptionProfile.Fields.Item("TelNumber").Value%>">
                              </td>
                            </tr>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("EmailAddress").Value%>">
                              </td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <textarea name="SubscriberComments" class="CastlesTextBlack" cols="30" rows="4"><%=(SubscriptionProfile.Fields.Item("SubscriberComments").Value)%></textarea>
                              </td>
                            </tr>
                            <tr> 
...
%>
                        ...
                        <td width="365" valign="top"> 
                          <table width="365" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ShippingFirstName" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingFirstName").Value%>">
                              </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;3&nbsp;] Shipping 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ShippingLastName" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingLastName").Value%>">
                              </td>
                            </tr>
							<tr> 
                              <td class="CastlesTextBody">[&nbsp;3&nbsp;] Shipping 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="ShippingAddressLine1" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingAddressLine1").Value%>">
                              </td>
                            </tr>
                            <tr> 
                              <td width="200" class="CastlesTextBody">[&nbsp;4&nbsp;] 
                            ...
                            <tr> 
                              <td width="200" class="CastlesTextBlack"> 
                                <input type="text" name="ShippingAddressLine2" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingAddressLine2").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="ShippingCity" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("ShippingCity").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="ShippingZipPostalCode" class="CastlesTextBlack" size="15" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("ShippingZipPostalCode").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardHolderName" class="CastlesTextBlack" size="25" maxlength="100" value="<%=SubscriptionProfile.Fields.Item("CreditCardHolderName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
...
'	DisplayCCNum = xString & lastFourDigits
end if
%>
                                <input type="text" name="CreditCardNumber" class="CastlesTextBlack" size="25" maxlength="50" value="<%=DisplayCCNum%>">
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardCSCCode" class="CastlesTextBlack" size="25" maxlength="50" value="<%=SubscriptionProfile.Fields.Item("CreditCardCSCCode").Value%>">
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardExpirationMonth" class="CastlesTextBlack" size="5" maxlength="2" value="<%=SubscriptionProfile.Fields.Item("CreditCardExpirationMonth").Value%>">
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;8&nbsp;] Credit 
                            ...
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <input type="text" name="CreditCardExpirationYear" class="CastlesTextBlack" size="10" maxlength="4" value="<%=SubscriptionProfile.Fields.Item("CreditCardExpirationYear").Value%>">
                              </td>
                            </tr>
                          </table>
                          <br>
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                ...
                                <input type="submit" name="Submit" value="Edit Subscription" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
