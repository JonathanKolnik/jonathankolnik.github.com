...
PageTopNavigationSubHeaderID = 15
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <form name="EditEntity" method="post" onSubmit="return Validate();" action="drivetelesales.asp?DCDataDriverType=SQLUpdate&SearchColumn=<%=SearchColumn%>&SearchValue=<%=SearchValue%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                          ...
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="FirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=TelesalesProfile.Fields.Item("FirstName").Value%>">
                                &nbsp;&nbsp; 
                                <input type="text" name="MiddleInitial" class="CastlesTextBlack" size="3" maxlength="1" value="<%=TelesalesProfile.Fields.Item("MiddleInitial").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="LastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=TelesalesProfile.Fields.Item("LastName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="DirectLine" class="CastlesTextBlack" size="20" maxlength="40" value="<%=TelesalesProfile.Fields.Item("DirectLine").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="MobileTelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=TelesalesProfile.Fields.Item("MobileTelNumber").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="FaxNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=TelesalesProfile.Fields.Item("FaxNumber").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=TelesalesProfile.Fields.Item("EmailAddress").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="NickName" class="CastlesTextBlack" size="20" maxlength="10" value="<%=TelesalesSystemLoginInfo.Fields.Item("NickName").Value%>">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="UserName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=TelesalesSystemLoginInfo.Fields.Item("UserName").Value%>">
                              </td>
                            </tr>
                            <%
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="password" name="Password" class="CastlesTextBlack" size="17" maxlength="10"  value="<%=TelesalesSystemLoginInfo.Fields.Item("Password").Value%>">
                              </td>
                            </tr>
                            <tr> 
...
%>
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="hidden" name="TeleSalesID" value="<%=TeleSalesID%>">
                                ...
                                <input type="submit" name="Submit" value="<%=WordPhrase_EditTelesales%>" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
