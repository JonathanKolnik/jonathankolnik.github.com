...
PageTopNavigationSubHeaderID = 14
EntityID = 4
%>
<!--#include virtual="/templates/castlessystemcnekt.asp" -->
<%
'---------------Begin Page Level Multilingual Translation-----------------------
WordPhrasesOnPage = "Active(|)Create Notes(|)Create TeleSales(|)Delete Notes(|)Direct Line(|)Email Address(|)Fax Number(|)First Name(|)Language(|)Last Name(|)Middle Initial(|)Mobile Phone(|)Nick Name(|)No(|)Password(|)Show Help(|)System Access Rights(|)System Notes Access(|)TeleSales Info(|)Username(|)View Notes(|)Yes"
...
TranslateCount = TranslateCount + 1
WordPhrase_CreateTeleSales = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <form name="CreateEntity" method="post" onSubmit="return Validate();" action="drivetelesales.asp?DCDataDriverType=SQLInsert&SearchColumn=<%=SearchColumn%>&SearchValue=<%=SearchValue%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                ...
                                <input type="submit" name="Submit" value="<%=WordPhrase_CreateTelesales%>" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
