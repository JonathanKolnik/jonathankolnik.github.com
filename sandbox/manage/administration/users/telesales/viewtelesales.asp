...
PageTopNavigationSubHeaderID = 17
FromPageTopNavigationSubHeaderID = 11
EntityID = 4
%>
<!--#include virtual="/templates/castlessystemcnekt.asp" -->
<%
'---------------Begin Page Level Multilingual Translation-----------------------
WordPhrasesOnPage = "Active(|)Create Notes(|)Delete Notes(|)Direct Line(|)Edit TeleSales(|)Email Address(|)Fax Number(|)First Name(|)Language(|)Last Name(|)Middle Initial(|)Mobile Phone(|)Nick Name(|)No(|)Password(|)Show Help(|)System Access Rights(|)System Notes Access(|)TeleSales Info(|)Username(|)View Notes(|)Yes"
...
TranslateCount = TranslateCount + 1
WordPhrase_EditTelesales = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
...
TranslateCount = TranslateCount + 1
WordPhrase_TeleSalesInfo = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
...
'Telesales Profile Info
TelesalesID = Request.QueryString("TelesalesID")
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
	.CommandText = "Castles_System_Telesales_Profile_System"
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4)
	.Parameters.Append .CreateParameter("@TelesalesID", 200, 1,200,TelesalesID)
	.CommandType = 4
	.CommandTimeout = 0
	.Prepared = true
	Set TelesalesProfile = .Execute()
End With
Set Command1 = Nothing

'Telesales SystemLogin Info
EntitySystemLoginID = TelesalesProfile.Fields.Item("SystemLoginID").Value
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
	...
	.CommandTimeout = 0
	.Prepared = true
	Set TelesalesSystemLoginInfo = .Execute()
End With
Set Command1 = Nothing
EntityLanguageID = TelesalesSystemLoginInfo.Fields.Item("LanguageID").Value
%>
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td bgcolor="<%=TitleBar%>" width="100%" class="CastlesTextHeader" height="20">&nbsp;&nbsp;&nbsp;<b><%=UCase(WordPhrase_TelesalesInfo)%></b></td>
              </tr>
                <tr> 
                        ...
                        <table width="350" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="FirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=TelesalesProfile.Fields.Item("FirstName").Value%>" disabled>
                              &nbsp;&nbsp; 
                              <input type="text" name="MiddleInitial" class="CastlesTextBlack" size="3" maxlength="1" value="<%=TelesalesProfile.Fields.Item("MiddleInitial").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="LastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=TelesalesProfile.Fields.Item("LastName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="DirectLine" class="CastlesTextBlack" size="20" maxlength="40" value="<%=TelesalesProfile.Fields.Item("DirectLine").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="MobileTelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=TelesalesProfile.Fields.Item("MobileTelNumber").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="FaxNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=TelesalesProfile.Fields.Item("FaxNumber").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=TelesalesProfile.Fields.Item("EmailAddress").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
...
%>
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <select name="Active" class="CastlesTextBlack" disabled>
                                <%If TelesalesProfile.Fields.Item("Active").Value = "Y" Then%>
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="NickName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=TelesalesSystemLoginInfo.Fields.Item("NickName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="UserName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=TelesalesSystemLoginInfo.Fields.Item("UserName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="password" name="Password" class="CastlesTextBlack" size="17" maxlength="10"  value="<%=TelesalesSystemLoginInfo.Fields.Item("Password").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <select name="ShowHelpContent" class="CastlesTextBlack" disabled>
                                <%If TelesalesSystemLoginInfo.Fields.Item("ShowHelpContent").Value = "Y" Then%>
                                <option value="Y" selected><%=WordPhrase_Yes%></option>
                                <option value="N"><%=WordPhrase_No%></option>
                                <%Else%>
                                <option value="Y"><%=WordPhrase_Yes%></option>
                            ...
                            <td> 
                              <table width="200" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="20"> 
                                    <%
If TelesalesSystemLoginInfo.Fields.Item("CreateNotes").Value = "Y" Then
%>
...
%>
                                ...
                                <tr> 
                                  <td width="20"> 
                                    <%
If TelesalesSystemLoginInfo.Fields.Item("DeleteNotes").Value = "Y" Then
%>
...
SystemLoginTypeID = TelesalesSystemLoginInfo.Fields.Item("SystemLoginTypeID").Value
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1	
	.ActiveConnection = Connect
