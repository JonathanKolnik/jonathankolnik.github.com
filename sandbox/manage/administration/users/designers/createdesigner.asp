...
TranslateCount = TranslateCount + 1
WordPhrase_CreateDesigner = TranslationResultsArray(Field_TranslatedWordPhrase,TranslateCount)
TranslateCount = TranslateCount + 1
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <form name="CreateEntity" method="post" onSubmit="return Validate();" action="drivedesigners.asp?DCDataDriverType=SQLInsert&SearchColumn=<%=SearchColumn%>&SearchValue=<%=SearchValue%>&Page=<%=Page%>&TotalRecords=<%=TotalRecords%>">
                <tr> 
                      ...
                      <tr> 
                        ...
                        <td rowspan="14" class="CastlesTextDark" valign="top"> 
                          <table width="350" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                <input type="text" name="CompanyName" class="CastlesTextBlack" size="20" maxlength="40">
                              </td>
                            </tr>
                            <tr> 
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="1">
                            <tr> 
                              <td class="CastlesTextBlack"> 
                                ...
                                <input type="submit" name="Submit" value="<%=WordPhrase_CreateDesigner%>" class="CastlesTextBlack">
                              </td>
                            </tr>
                            <tr> 
                              <td>&nbsp;</td>
