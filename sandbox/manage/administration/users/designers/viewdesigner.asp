...
PageTopNavigationSubHeaderID = 21
                        ...
                        <table width="350" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="FirstName" class="CastlesTextBlack" size="15" maxlength="50" value="<%=DesignerProfile.Fields.Item("FirstName").Value%>" disabled>
                              &nbsp;&nbsp; 
                              <input type="text" name="MiddleInitial" class="CastlesTextBlack" size="3" maxlength="1" value="<%=DesignerProfile.Fields.Item("MiddleInitial").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="LastName" class="CastlesTextBlack" size="20" maxlength="50" value="<%=DesignerProfile.Fields.Item("LastName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="CompanyName" class="CastlesTextBlack" size="20" maxlength="40" value="<%=DesignerProfile.Fields.Item("CompanyName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="DirectLine" class="CastlesTextBlack" size="20" maxlength="40" value="<%=DesignerProfile.Fields.Item("DirectLine").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="MobileTelNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=DesignerProfile.Fields.Item("MobileTelNumber").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="FaxNumber" class="CastlesTextBlack" size="20" maxlength="40" value="<%=DesignerProfile.Fields.Item("FaxNumber").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="EmailAddress" class="CastlesTextBlack" size="30" maxlength="100" value="<%=DesignerProfile.Fields.Item("EmailAddress").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
...
%>
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="NickName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=DesignerSystemLoginInfo.Fields.Item("NickName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="text" name="UserName" class="CastlesTextBlack" size="20" maxlength="100" value="<%=DesignerSystemLoginInfo.Fields.Item("UserName").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td class="CastlesTextBlack"> 
                              <input type="password" name="Password" class="CastlesTextBlack" size="17" maxlength="10"  value="<%=DesignerSystemLoginInfo.Fields.Item("Password").Value%>" disabled>
                            </td>
                          </tr>
                          <tr> 
