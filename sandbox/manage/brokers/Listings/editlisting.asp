...
PageTopNavigationSubHeaderID = 35
FromPageTopNavigationSubHeaderID = 34
EntityID = 10
%>
...
With Command1	
	.ActiveConnection = Connect
	.CommandText = "Castles_System_Listing_Details_ForBroker"
	.Parameters.Append .CreateParameter("@RETURN_VALUE", 3, 4)
...
%>							
							<tr> 
                              <td class="CastlesTextBody"><input type="checkbox" name="ShowListPrice" value="Y" <%=LP_checked%>>&nbsp;Show List Price on Website?</td>
                            </tr>
							<tr> 
                            ...
                            <tr> 
                              <td class="CastlesTextBlack"> 
								<input type="text" name="TaxYear" class="CastlesTextBlack" size="10" maxlength="20" value="<%=ListingProfile.Fields.Item("TaxYear").Value%>"> <span class="CastlesTextBody"><font color="#FF0000">*</font></span> 
                              </td>
                            </tr>
							<tr> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;28&nbsp;] Active:&nbsp;<strong><%=ListingProfile.Fields.Item("Active").Value%></strong></td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBlack"> 
                              </td>
                        ...
                        <td width="365" class="CastlesTextBody" valign="top"> 
                          <table cellspacing="0" cellpadding="3" border="0" width="365">
                            <tr> 
                              <td  class="CastlesTextBody">[&nbsp;29&nbsp;] Hot 
                                Water:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;30&nbsp;] Heating:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;31&nbsp;] Cooling:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;32&nbsp;] Exterior 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;34&nbsp;] Interior 
                                Features:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;35&nbsp;] Appliances:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;36&nbsp;] Flooring:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;37&nbsp;] Foundation 
                                Type:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
...
%>
                            ...
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;38&nbsp;] Interior 
                                Description:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <textarea name="InteriorDescription" cols="30" rows="5" class="CastlesTextBlack" wrap="VIRTUAL"><%=ListingProfile.Fields.Item("InteriorDescription").Value%>
								</textarea>
                              </td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody">[&nbsp;39&nbsp;] Exterior 
                                Description:</td>
                            </tr>
                            <tr> 
                              <td class="CastlesTextBody"> 
                                <textarea name="ExteriorDescription" cols="30" rows="5" class="CastlesTextBlack" wrap="VIRTUAL"><%=ListingProfile.Fields.Item("ExteriorDescription").Value%>
								</textarea>
                              </td>
                            </tr>
...
%>							
							...
							<tr> 
                              <td class="CastlesTextBody">&nbsp;&nbsp;* Note: 
                                It is very important that you use an image editing 
                                program (eg. Photoshop) to resize/crop the images 
                                to be exactly 300px in width and 300px in height. 
                                It is equally important that you save/export the 
                                images to a web format (eg. JPEG or GIF).</td>
                            </tr>
                            <tr valign="top">
<%
