...
%>
  ...
  <tr> 
    <td bgcolor="#FFFFFF"><!-- #BeginEditable "body" --> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td bgcolor="<%=ThinLine%>"><img src="../images/clear10pixel.gif" width="1" height="1"></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <td>
		  	<table width="75%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="5%">&nbsp;</td>
					<td width="70%" class="CastlesTextBody">
<%
Select Case SystemLoginTypeID
	'Administrators
	Case 1
	...
	Case 4
%>
		Welcome <%=SystemLoginNickName%>,<br><br>
                  <a href="brokers/listings/createlisting.asp">Click Here</a> 
                  to place a new listing.<br>
                  <br>
		 <a href="brokers/listings/searchlistings.asp">Click Here</a> to search your listings.<br><br>
		 <a href="brokers/messages/searchmessages.asp">Click Here</a> to check your messages.<br><br>
<%
End Select	
%>					
