                    ...
                    <tr> 
                      ...
                      <td width="375" valign="top"> 
                        <table width="375" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr> 
                            <td class="CastlesTextBody"><b>Welcome to Castles Magazine.</b></td>
                          </tr>
                                ...
                                <table width="350" border="0" cellspacing="0" cellpadding="2">
                                  <tr align="left"> 
                                    <td colspan="2" class="CastlesTextBody"><b>Successful 
                                      Account Creation</b></td>
                                  </tr>
                                  <tr align="left"> 
                                    <td colspan="2" class="CastlesTextBody">
                                      <p>Thank you for setting up a broker account 
                                        with Castles Magazine. We will activate your 
                                        account after reviewing information. If you don't 
										hear anything from us within 24 hours or if you have 
										any questions regarding your 
                                        account please contact us via email at 


 info@castlesmag.com or via telephone 
                                        at  888.887.0777.</p>
                                      <p>Thanks,</p>
                                    <p>Castles Magazine</p>                                    </td>
                                  </tr>
                                  <%
Set Command1 = Server.CreateObject("ADODB.Command")
With Command1
